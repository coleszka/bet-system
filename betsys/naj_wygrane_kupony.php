...
<body>
  ...
  <thead>
    <tr>
      <th colspan="5">Najwyższe wygrane kupony</th>
    </tr>
    <tr>
      <th colspan="1">#</th>
...
<?php
			...
			$query_ranking = $conn->query("SELECT wygrana, wynik, id_user, kurs, stawka, id, user FROM postawione_kupony, uzytkownicy WHERE wynik='W' AND postawione_kupony.id_user=uzytkownicy.id ORDER BY wygrana DESC LIMIT 10");  /*WHERE date='$today'*/
